...
教程部分的示例代码采用的是[@sinoui/web-forms](form)作为 UI 展示的。如果使用的是 sinoui-components，可以参考[@sinoui/sinoui-components-forms](sinoui-components-forms)。教程代码虽然采用的是@sinoui/web-forms，但是可以直接使用@sinoui/sinoui-components-forms 中的组件替换@sinoui/web-forms 相对应的组件即可使用示例代码。
