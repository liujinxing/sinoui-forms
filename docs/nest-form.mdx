...
[@sinoui/rx-form-state](https://github.com/sinoui/sinoui-forms/tree/master/packages/rx-form-state)的表单域`name`属性支持
...
[@sinoui/rx-form-state](https://github.com/sinoui/sinoui-forms/tree/master/packages/rx-form-state)
还提供了[useFieldArray](/use-field-array)和[FieldArray](/field-array)辅助嵌套表单的开发。
